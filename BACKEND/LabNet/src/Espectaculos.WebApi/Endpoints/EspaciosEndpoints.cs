...
public static class EspaciosEndpoints
{
    public static IEndpointRouteBuilder MapEspaciosEndpoints(this IEndpointRouteBuilder endpoints)
    {
        var group = endpoints.MapGroup("espacios");

        group.MapGet("/", async ([FromServices] IMediator mediator) =>
        {
            var query = new ListarEspaciosQuery();
